...
| Compare App |
|:--------------|
[![Build status](https://ci.appveyor.com/api/projects/status/3fe1696ae02990ae1249/branch/master?svg=true)](https://ci.appveyor.com/project/PhilShishov/compare-app)
